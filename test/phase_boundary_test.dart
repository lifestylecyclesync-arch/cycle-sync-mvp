...
void main() {
  group('Phase Boundary Tests (Refined Formula)', () {
    ...
    test('Menstrual Phase: Days 1-5', () {
      expect(getCyclePhase(lastPeriodStart, cycleLength, DateTime(2024, 1, 1), menstrualLength: menstrualLength), 'Menstrual'); // Day 1
      expect(getCyclePhase(lastPeriodStart, cycleLength, DateTime(2024, 1, 3), menstrualLength: menstrualLength), 'Menstrual'); // Day 3
      expect(getCyclePhase(lastPeriodStart, cycleLength, DateTime(2024, 1, 5), menstrualLength: menstrualLength), 'Menstrual'); // Day 5
    });

    test('Follicular Phase: Days 6-12', () {
      expect(getCyclePhase(lastPeriodStart, cycleLength, DateTime(2024, 1, 6), menstrualLength: menstrualLength), 'Follicular'); // Day 6
      expect(getCyclePhase(lastPeriodStart, cycleLength, DateTime(2024, 1, 10), menstrualLength: menstrualLength), 'Follicular'); // Day 10
      expect(getCyclePhase(lastPeriodStart, cycleLength, DateTime(2024, 1, 12), menstrualLength: menstrualLength), 'Follicular'); // Day 12 (OD-2)
    });
    ...
    test('Late Luteal Phase: Days 20-28', () {
      expect(getCyclePhase(lastPeriodStart, cycleLength, DateTime(2024, 1, 20), menstrualLength: menstrualLength), 'Luteal'); // Day 20 (OD+6)
      expect(getCyclePhase(lastPeriodStart, cycleLength, DateTime(2024, 1, 25), menstrualLength: menstrualLength), 'Luteal'); // Day 25
      expect(getCyclePhase(lastPeriodStart, cycleLength, DateTime(2024, 1, 28), menstrualLength: menstrualLength), 'Luteal'); // Day 28 (last day)
    });
    ...
    group('26-day cycle tests', () {
      ...
      test('26-day cycle boundaries: Follicular Days 6-10, OD Days 11-13, EL Days 14-17, LL Days 18-26', () {
        expect(getCyclePhase(lastPeriodStart, cycleLength26, DateTime(2024, 1, 6), menstrualLength: menstrualLength), 'Follicular'); // Day 6
        expect(getCyclePhase(lastPeriodStart, cycleLength26, DateTime(2024, 1, 10), menstrualLength: menstrualLength), 'Follicular'); // Day 10 (OD-2)
        ...
        expect(getCyclePhase(lastPeriodStart, cycleLength26, DateTime(2024, 1, 18), menstrualLength: menstrualLength), 'Luteal'); // Day 18 (OD+6)
      });
    });
    ...
    group('32-day cycle tests', () {
      ...
      test('32-day cycle boundaries: Follicular Days 6-16, OD Days 17-19, EL Days 20-23, LL Days 24-32', () {
        expect(getCyclePhase(lastPeriodStart, cycleLength32, DateTime(2024, 1, 6), menstrualLength: menstrualLength), 'Follicular'); // Day 6
        expect(getCyclePhase(lastPeriodStart, cycleLength32, DateTime(2024, 1, 16), menstrualLength: menstrualLength), 'Follicular'); // Day 16 (OD-2)
        ...
        expect(getCyclePhase(lastPeriodStart, cycleLength32, DateTime(2024, 1, 24), menstrualLength: menstrualLength), 'Luteal'); // Day 24 (OD+6)
      });
    });
    ...
    group('Variable menstrual length tests', () {
      test('7-day menstrual length: Menstrual Days 1-7', () {
        ...
        expect(getCyclePhase(lastPeriodStart, cycleLength, DateTime(2024, 1, 7), menstrualLength: ml7), 'Menstrual'); // Day 7
        expect(getCyclePhase(lastPeriodStart, cycleLength, DateTime(2024, 1, 8), menstrualLength: ml7), 'Follicular'); // Day 8 (should be follicular, not menstrual)
      });

      test('3-day menstrual length: Menstrual Days 1-3', () {
        final ml3 = 3;
        expect(getCyclePhase(lastPeriodStart, cycleLength, DateTime(2024, 1, 1), menstrualLength: ml3), 'Menstrual'); // Day 1
        expect(getCyclePhase(lastPeriodStart, cycleLength, DateTime(2024, 1, 3), menstrualLength: ml3), 'Menstrual'); // Day 3
        expect(getCyclePhase(lastPeriodStart, cycleLength, DateTime(2024, 1, 4), menstrualLength: ml3), 'Follicular'); // Day 4
      });
    });
  });
}
